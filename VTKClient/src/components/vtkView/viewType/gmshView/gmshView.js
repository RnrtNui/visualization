...
export default class GmshView extends Component {
    ...
    render() {
        ...
        let { bounds, moveStyle, modelStyle, axis, scalar, screen, light, attribute, result } = state;
        ...
        return (
            <div>
                ...
                <div style={{ width: "160px", minWidth: "90px", height: "18%", position: "absolute", right: "50px", bottom: "50px", opacity: scalar }}>
                    <div className="vtk-container1" ref={this.container1} style={{ width: "20px", minWidth: "20px", height: "calc(100% - 19px)", position: "relative", opacity: scalar, overflow: "hidden", margin: "10px 0 10px", float: "left", borderRight: "1px solid #FFF" }}></div>
